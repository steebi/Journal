<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-13 11:35:54
         compiled from "./templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15359491715502c50d47e2d7-77820508%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e07fadc9316a5d18f7a9d53ee3b9a67bc36ff2b' => 
    array (
  ...
  'nocache_hash' => '15359491715502c50d47e2d7-77820508',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5502c50d582e12_06386008',
  'variables' => 
  array (
    'notes' => 0,
    'note' => 0,
...
<?php if ($_valid && !is_callable('content_5502c50d582e12_06386008')) {function content_5502c50d582e12_06386008($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/smsc1403/public_html/Journal/lib/plugins/modifier.truncate.php';
...
" <?php if ($_smarty_tpl->tpl_vars['note']->value['id']==$_smarty_tpl->tpl_vars['ACTIVE_NOTE_ID']->value) {?>class='active'<?php }?>><?php echo strip_tags(smarty_modifier_truncate($_smarty_tpl->tpl_vars['note']->value['content'],20));?>
    ...
    <div id="notepad">
        ...
        <div>
		<!-- If there is a current actve note then set the timestamp on the page to the note timestamp and fill the text area with the note's content -->
            <?php  $_smarty_tpl->tpl_vars['note'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['note']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['notes']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['note']->key => $_smarty_tpl->tpl_vars['note']->value) {
$_smarty_tpl->tpl_vars['note']->_loop = true;
